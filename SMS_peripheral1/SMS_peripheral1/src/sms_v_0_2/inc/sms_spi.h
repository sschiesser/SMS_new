...
/* Pins */
#define SPI_MASTER_MS58_PIN_SCK     PIN_LP_GPIO_17 // XPLAINED PRO --> EXT3:18
#define SPI_MASTER_MS58_PIN_MOSI    PIN_LP_GPIO_19 // XPLAINED PRO --> EXT3:16
#define SPI_MASTER_MS58_PIN_SSN     PINMUX_UNUSED
#define SPI_MASTER_MS58_MISO        PIN_LP_GPIO_18 // XPLAINED PRO --> EXT3:17
/* Mux */
